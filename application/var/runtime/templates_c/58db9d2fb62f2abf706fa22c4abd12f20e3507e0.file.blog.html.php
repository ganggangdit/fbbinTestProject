<?php /* Smarty version Smarty-3.1.7, created on 2012-06-02 13:47:25
         compiled from "application/views/search/blog.html" */ ?>
<?php /*%%SmartyHeaderCode:20706895314fc9a8ed39a8b5-33467990%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '58db9d2fb62f2abf706fa22c4abd12f20e3507e0' => 
    array (
      0 => 'application/views/search/blog.html',
      1 => 1336010856,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20706895314fc9a8ed39a8b5-33467990',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fc9a8ed55512',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fc9a8ed55512')) {function content_4fc9a8ed55512($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ((@WEB_ROOT_SMARTY)."main/application/views/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
"><?php echo $_smarty_tpl->tpl_vars['user_name']->value;?>
				...
				<span class="nameTxt"><a href="<?php echo $_smarty_tpl->tpl_vars['app_url_list']->value['blog'];?>
">搜索</a></span>
				<div class="dropMenu">
					<div class="triggerBtn"><span class="fl">博客</span><s></s></div>
					<div class="dropList">
						<ul class="dropListul">
...
">博客(<?php echo $_smarty_tpl->tpl_vars['total']->value;?>
)</h3>
			<?php if ($_smarty_tpl->tpl_vars['isEmpty']->value==true){?>
			<div class="noResult">未搜索到相应结果，请重新输入关键字</div>
			<?php }else{ ?>
			<div class="searchResult" id="blogResult">
				<ul class="clearfix">
				<?php  $_smarty_tpl->tpl_vars['vo'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['vo']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['blog']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['name_txt'];?>
						...
						<div class="bc" title="<?php echo $_smarty_tpl->tpl_vars['vo']->value['fulltext'];?>
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['text'];?>
</div>
						<span class="gray">作者:</span> <a href="<?php echo $_smarty_tpl->tpl_vars['vo']->value['authorUrl'];?>
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['author'];?>
</a>
					</li>
				<?php } ?>
				</ul>
...
main/?c=search&m=main&type=blog" rel="1" class="hide">查看更多博客<i></i></a>
