<?php /* Smarty version Smarty-3.1.7, created on 2012-06-01 15:31:57
         compiled from "application/views/edit/school_company/primaryschool.html" */ ?>
<?php /*%%SmartyHeaderCode:4760548624fc86feda14c20-81081216%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b42f8906b699cf7624506acb165b4259eedc7bcd' => 
    array (
      0 => 'application/views/edit/school_company/primaryschool.html',
      1 => 1336960318,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4760548624fc86feda14c20-81081216',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_4fc86fedacbce',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fc86fedacbce')) {function content_4fc86fedacbce($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<script type="text/javascript" src="<?php echo @MISC_ROOT;?>
js/tempJS/primaryschool/11.js"></script>
	...
	var SC = {
		...
		loadList: function(val) {
			var listData = '',
				...
				cache = SC.cache;
			$.get(miscpath+'js/tempJS/primaryschool/'+path, function(data) {
				var ul = '';
		...
		selectCallback: function() {
			$('#selectCont').delegate('a', 'click', function() {
				...
				window.parent.currentCollegeCallback(self.title, self.id, input,"primarySchool", p_id);
