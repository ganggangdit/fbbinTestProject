<?php /* Smarty version Smarty-3.1.7, created on 2012-06-02 13:47:32
         compiled from "application/views/search/ask.html" */ ?>
<?php /*%%SmartyHeaderCode:11546468384fc9a8f42c3054-77216509%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9723f7ffcbc5d13993060a6bd623bceedfc914c7' => 
    array (
      0 => 'application/views/search/ask.html',
      1 => 1337745522,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11546468384fc9a8f42c3054-77216509',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fc9a8f44f9c7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fc9a8f44f9c7')) {function content_4fc9a8f44f9c7($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ((@WEB_ROOT_SMARTY)."main/application/views/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
"><?php echo $_smarty_tpl->tpl_vars['user_name']->value;?>
				...
				<span class="nameTxt"><a href="<?php echo $_smarty_tpl->tpl_vars['app_url_list']->value['answer'];?>
">搜索</a></span>
				<div class="dropMenu">
					<div class="triggerBtn"><span class="fl">问答</span><s></s></div>
					<div class="dropList">
						<ul class="dropListul">
...
?>
					<?php if ($_smarty_tpl->tpl_vars['vo']->value['ask']['type']==0){?>
					<li class="searchLi">
						<h5 class="bt"><a href="<?php echo $_smarty_tpl->tpl_vars['vo']->value['url'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['name_txt'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['vo']->value['ask']['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['id']->key => $_smarty_tpl->tpl_vars['id']->value){
$_smarty_tpl->tpl_vars['id']->_loop = true;
?>
							<li title="<?php echo $_smarty_tpl->tpl_vars['id']->value['fulltext'];?>
">
								<input type="radio" disabled="disabled" />
								<div>
									<p><?php echo $_smarty_tpl->tpl_vars['id']->value['name'];?>
</p>
									<span style="width:<?php echo $_smarty_tpl->tpl_vars['id']->value['percent'];?>
%;"></span>
								</div>
							</li>
						<?php } ?>
						<?php if ($_smarty_tpl->tpl_vars['vo']->value['ask']['more_link']==true){?>
							<li>
...
main/?c=search&m=main&type=answer" rel="1" class="hide">查看更多问答<i></i></a>
