<?php /* Smarty version Smarty-3.1.7, created on 2012-06-02 13:46:14
         compiled from "application/views/search/status.html" */ ?>
<?php /*%%SmartyHeaderCode:8643461444fc9a8a63a9f03-92671792%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c5209cd743dfbcab59d34791fc26c57b270627ec' => 
    array (
      0 => 'application/views/search/status.html',
      1 => 1336010856,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8643461444fc9a8a63a9f03-92671792',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fc9a8a6563b2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fc9a8a6563b2')) {function content_4fc9a8a6563b2($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ((@WEB_ROOT_SMARTY)."main/application/views/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
"><?php echo $_smarty_tpl->tpl_vars['user_name']->value;?>
				...
				<span class="nameTxt"><a href="<?php echo $_smarty_tpl->tpl_vars['app_url_list']->value['status'];?>
">搜索</a></span>
				<div class="dropMenu">
					<div class="triggerBtn"><span class="fl">状态</span><s></s></div>
					<div class="dropList">
						<ul class="dropListul">
...
" alt="" /></a>
						<p class="searchCont">
							<a href="<?php echo $_smarty_tpl->tpl_vars['vo']->value['url'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['vo']->value['name_txt'];?>
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['name_txt'];?>
</a> <span class="gray"><?php echo $_smarty_tpl->tpl_vars['vo']->value['time'];?>
</span>
...
main/?c=search&m=main&type=status" rel="1" class="hide">查看更多状态<i></i></a>
