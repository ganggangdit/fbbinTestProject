<?php /* Smarty version Smarty-3.1.7, created on 2012-06-01 16:09:11
         compiled from "application/views/following/bothlist.html" */ ?>
<?php /*%%SmartyHeaderCode:12984756154fc878a74fae10-93217572%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0d029b561b64a8329d6d939cbab9c2973aca424f' => 
    array (
      0 => 'application/views/following/bothlist.html',
      1 => 1336465692,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12984756154fc878a74fae10-93217572',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fc878a769f7f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fc878a769f7f')) {function content_4fc878a769f7f($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
">互相关注列表</a></span>
		...
		<div class="modlueBody">
						...
						<h4>互相关注 (<?php echo $_smarty_tpl->tpl_vars['followings_count']->value;?>
)</h4>
...
"><?php echo $_smarty_tpl->tpl_vars['following']->value['name'];?>
                             ...
                             <?php }?>
                            <?php }else{ ?>
                             <div class="blankWrap" id="nodata"><span>您还没有互相关注对象</span></div>
                            <?php }?>
                        <?php }else{ ?>
                            <?php if ($_smarty_tpl->tpl_vars['followings_count']->value){?>
                            <ul class="listWrap clearfix" id="listWrap">
...
"><?php echo $_smarty_tpl->tpl_vars['following']->value['name'];?>
                             ...
                             <?php }?>
                            <?php }else{ ?>
                             <div class="blankWrap"><span>该用户还没有互相关注对象</span></div>
                            <?php }?>
                        <?php }?>
...
$(function() {
	list.init({visibleUrl:'main/following/visibleFollowing', moreUrl:'main/following/getBothFollowingsByPage', searchUrl:'main/following/searchBothFollowingByUserName'});
});
</script>
