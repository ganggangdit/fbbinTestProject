...
class Redisdb{
	 ...
	 *
	 */
	 public function hmget($uid){
		$field = array('id','name','dkcode','sex');
		return $this->redis->hmget('user:'.$uid,$field);
	 }
	/**
	 *设置redis中的数据
	 *
	 */
	 public function hmset($uid,$val){		
		return $this->redis->hmset('user:'.$uid,$val);
	 }
